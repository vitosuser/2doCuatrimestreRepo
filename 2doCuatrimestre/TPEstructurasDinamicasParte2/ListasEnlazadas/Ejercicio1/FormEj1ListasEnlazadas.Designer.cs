namespace TPEstructurasDinamicasParte2.Listas_Enlazadas.Ejercicio1
{
    partial class FormEj1ListasEnlazadas
    {
        ...
        private void InitializeComponent()
        {
            ...
            gboxAccion.Controls.Add(rdioSentar);
            ...
            rdioEliminar.Location = new Point(16, 91);
            rdioEliminar.Margin = new Padding(3, 2, 3, 2);
            rdioEliminar.Name = "rdioEliminar";
            rdioEliminar.Size = new Size(172, 23);
            rdioEliminar.TabIndex = 2;
            rdioEliminar.TabStop = true;
            rdioEliminar.Text = "Eliminar Cliente de Lista";
            rdioEliminar.UseVisualStyleBackColor = true;
            rdioEliminar.CheckedChanged += rdioEliminar_CheckedChanged;
            // 
            // rdioSentar
            // 
            rdioSentar.AutoSize = true;
            rdioSentar.Font = new Font("Segoe UI", 10F);
            rdioSentar.Location = new Point(16, 60);
            rdioSentar.Margin = new Padding(3, 2, 3, 2);
            rdioSentar.Name = "rdioSentar";
            rdioSentar.Size = new Size(170, 23);
            rdioSentar.TabIndex = 1;
            rdioSentar.TabStop = true;
            rdioSentar.Text = "Sentar al Primer Cliente";
            rdioSentar.UseVisualStyleBackColor = true;
            rdioSentar.CheckedChanged += rdioSentar_CheckedChanged;
            // 
            // rdioAgregar
            // 
        ...
        private RadioButton rdioSentar;
